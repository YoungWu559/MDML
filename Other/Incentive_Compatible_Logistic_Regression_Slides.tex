...
\end{itemize}\begin{align*}
\mathbb{P}\left\{Y = \text{\;red\;} | w^\star , x_{\text{\;square\;}}\right\} &= 0.3290, \text{\;but\;}
\\ \mathbb{P}\left\{Y = \text{\;red\;} | w^\star \left(y^{\dagger}_{\text{\;square\;}} = \text{\;blue\;}\right), x_{\text{\;square\;}}\right\} &= 0.4966.
\end{align*}
...
\begin{itemize}
\item An agent in class $a $ is mis-classified as $b $ may want to misreport as $c $ to move the decision boundary between $a $ and $b. $
