...
#repeat_test()
list <- c(120, 216, 437, 1143, 1341, 1436, 1949, 2016, 2079, 2604, 2720, 2722, 2966, 3671, 3957, 4128, 4144, 4204, 4741, 4813, 4865, 5105, 5305, 5389, 5390, 5606, 5661, 5693, 5885, 6106, 6733, 7314, 7509, 7863, 8017, 8052, 8240, 8983, 9133, 9363, 9388)
for (l in list) {
  data <- gen_data(seed = l, dim = 2, k = 3, n = 100, sep = 1, var = 1)
  #write.table(data, file = paste("ic_", l, ".txt", sep = ""))
  test(data, seed = l, out = FALSE, method = 0, lam = 0)
}
