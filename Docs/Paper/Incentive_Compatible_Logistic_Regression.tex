...
\newline \newline
The decision boundaries can be related in more complicated ways. Consider another $3$-way classifier $h_{t} : \mathbb{R} \to  \left\{\text{\;red\;}, \text{\;green\;}, \text{\;blue\;}\right\}$ parameterized by two thresholds $a $ and $b. $
\[ h_{a, b}\left(x\right) =\left\{ \begin{array}{ll}
\text{\;red\;}& \text{\;if\;} x < a \\
